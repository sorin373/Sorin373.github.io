function createUnityInstance(e, t, r) {
        ...
        f.preRun.push(function () {
            f.addRunDependency("dataUrl"), e.then(function (e) {
                ...
                for (r += 4; r < o;) {
                    ...
                    r += s;
                    for (var d = 0, u = l.indexOf("/", d) + 1; u > 0; d = u, u = l.indexOf("/", d) + 1) f.FS_createPath(l.substring(0, d), l.substring(d, u - 1), !0, !0);
    ...
    b.forEach(function (t) {
        ...
        f.disableAccessToMediaDevices(), b.forEach(function (t) {
    ...
    document.addEventListener("webkitfullscreenchange", function (t) {
        ...
        r === e ? e.style.width && (m = e.style.width, g = e.style.height, e.style.width = "100%", e.style.height = "100%") : m && (e.style.width = m, e.style.height = g, m = "", g = "")
    });
    var p = {
        Module: f,
    ...
    f.SystemInfo = function () {
        ...
        function i(i, u) {
            ...
            return u && (m.control = u.control, m.company = u.company, m.product = u.product), m.result = o(b, m.company, m.product, Date.now()), m.revalidated = !1, m.enabled ? h.loadRequest(m.result.url).then(function (t) {
                ...
                if ("immutable" == m.control) return m.revalidated = !0, h.storeRequest(m.result), e("'" + m.result.url + "' served from the indexedDB cache without revalidation"), f(o), o;
                if (r(m.result.url) && (o.headers.get("Last-Modified") || o.headers.get("ETag"))) return fetch(m.result.url, {
                    method: "HEAD"
                }).then(function (t) {
                ...
                var t = {
                    "inflate.js": function (e, t, r) {
                        ...
                        n.prototype.push = function (e, t) {
                            ...
                            do {
                                if (0 === f.avail_out && (f.output = new s.Buf8(b), f.next_out = 0, f.avail_out = b), r = i.inflate(f, d.Z_NO_FLUSH), r === d.Z_NEED_DICT && m && (c = "string" == typeof m ? l.string2buf(m) : "[object ArrayBuffer]" === h.call(m) ? new Uint8Array(m) : m, r = i.inflateSetDictionary(this.strm, c)), r === d.Z_BUF_ERROR && g === !0 && (r = d.Z_OK, g = !1), r !== d.Z_STREAM_END && r !== d.Z_OK) return this.onEnd(r), this.ended = !0, !1;
                                f.next_out && (0 !== f.avail_out && r !== d.Z_STREAM_END && (0 !== f.avail_in || n !== d.Z_FINISH && n !== d.Z_SYNC_FLUSH) || ("string" === this.options.to ? (o = l.utf8border(f.output, f.next_out), a = f.next_out - o, u = l.buf2string(f.output, o), f.next_out = a, f.avail_out = b - a, a && s.arraySet(f.output, f.output, o, a, 0), this.onData(u)) : this.onData(s.shrinkBuf(f.output, f.next_out)))), 0 === f.avail_in && 0 === f.avail_out && (g = !0)
                    ...
                    "zlib/inflate.js": function (e, t, r) {
                        ...
                        function a(e) {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = z, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(me), t.distcode = t.distdyn = new w.Buf32(ge), t.sane = 1, t.back = -1, T) : O
                        }
                        ...
                        function u(e) {
                            if (ve) {
                                var t;
                                for (g = new w.Buf32(512), p = new w.Buf32(32), t = 0; t < 144;) e.lens[t++] = 8;
                        ...
                        function f(e, t) {
                            var r, o, a, i, s, l, d, f, h, b, m, g, p, me, ge, pe, we, ve, ye, ke, xe, _e, Se, Ee, Ce = 0,
                                Be = new w.Buf8(4),
                                Ue = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return O;
                            r = e.state, r.mode === Y && (r.mode = V), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = r.hold, h = r.bits, b = l, m = d, _e = T;
                            e: for (;;) switch (r.mode) {
                                case z:
                                    if (0 === r.wrap) {
                                        r.mode = V;
                                    ...
                                    if (2 & r.wrap && 35615 === f) {
                                        r.check = 0, Be[0] = 255 & f, Be[1] = f >>> 8 & 255, r.check = y(r.check, Be, 2, 0), f = 0, h = 0, r.mode = N;
                                        break
                                    }
                                    ...
                                    r.dmax = 1 << xe, e.adler = r.check = 1, r.mode = 512 & f ? q : Y, f = 0, h = 0;
                                    break;
                                case N:
                                    for (; h < 16;) {
                                        if (0 === l) break e;
                                    ...
                                    r.head && (r.head.text = f >> 8 & 1), 512 & r.flags && (Be[0] = 255 & f, Be[1] = f >>> 8 & 255, r.check = y(r.check, Be, 2, 0)), f = 0, h = 0, r.mode = F;
                                case F:
                                    for (; h < 32;) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    r.head && (r.head.time = f), 512 & r.flags && (Be[0] = 255 & f, Be[1] = f >>> 8 & 255, Be[2] = f >>> 16 & 255, Be[3] = f >>> 24 & 255, r.check = y(r.check, Be, 4, 0)), f = 0, h = 0, r.mode = Z;
                                case Z:
                                    for (; h < 16;) {
                                        if (0 === l) break e;
                                        l--, f += o[i++] << h, h += 8
                                    }
                                    r.head && (r.head.xflags = 255 & f, r.head.os = f >> 8), 512 & r.flags && (Be[0] = 255 & f, Be[1] = f >>> 8 & 255, r.check = y(r.check, Be, 2, 0)), f = 0, h = 0, r.mode = j;
                                case j:
                                    if (1024 & r.flags) {
                                        for (; h < 16;) {
                                            if (0 === l) break e;
                                        ...
                                        r.length = f, r.head && (r.head.extra_len = f), 512 & r.flags && (Be[0] = 255 & f, Be[1] = f >>> 8 & 255, r.check = y(r.check, Be, 2, 0)), f = 0, h = 0
                                    } else r.head && (r.head.extra = null);
                                    r.mode = H;
                                case H:
                                    if (1024 & r.flags && (g = r.length, g > l && (g = l), g && (r.head && (xe = r.head.extra_len - r.length, r.head.extra || (r.head.extra = new Array(r.head.extra_len)), w.arraySet(r.head.extra, o, i, g, xe)), 512 & r.flags && (r.check = y(r.check, o, g, i)), l -= g, i += g, r.length -= g), r.length)) break e;
                                    r.length = 0, r.mode = M;
                                case M:
                                    if (2048 & r.flags) {
                                        if (0 === l) break e;
                                        g = 0;
                                        do xe = o[i + g++], r.head && xe && r.length < 65536 && (r.head.name += String.fromCharCode(xe)); while (xe && g < l);
                                        if (512 & r.flags && (r.check = y(r.check, o, g, i)), l -= g, i += g, xe) break e
                                ...
                                case W:
                                    if (4096 & r.flags) {
                                        if (0 === l) break e;
                                        g = 0;
                                        do xe = o[i + g++], r.head && xe && r.length < 65536 && (r.head.comment += String.fromCharCode(xe)); while (xe && g < l);
                                        if (512 & r.flags && (r.check = y(r.check, o, g, i)), l -= g, i += g, xe) break e
                                ...
                                case K:
                                    if (0 === r.havedict) return e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, r.hold = f, r.bits = h, L;
                                ...
                                case Q:
                                    ...
                                    if (r.length = 65535 & f, f = 0, h = 0, r.mode = X, t === U) break e;
                                case X:
                                    r.mode = J;
                                case J:
                                    if (g = r.length) {
                                        if (g > l && (g = l), g > d && (g = d), 0 === g) break e;
                                        w.arraySet(a, o, i, g, s), l -= g, i += g, d -= g, s += g, r.length -= g;
                                        break
                                    }
                                    r.mode = Y;
                                    break;
                                    ...
                                    for (; r.have < r.nlen + r.ndist;) {
                                        ...
                                        if (we < 16) f >>>= ge, h -= ge, r.lens[r.have++] = we;
                                            ...
                                            if (16 === we) {
                                                ...
                                                xe = r.lens[r.have - 1], g = 3 + (3 & f), f >>>= 2, h -= 2
                                            } else if (17 === we) {
                                                for (Ee = ge + 3; h < Ee;) {
                                                    if (0 === l) break e;
                                                    l--, f += o[i++] << h, h += 8
                                                }
                                                f >>>= ge, h -= ge, xe = 0, g = 3 + (7 & f), f >>>= 3, h -= 3
                                            } else {
                                                for (Ee = ge + 7; h < Ee;) {
                                                    if (0 === l) break e;
                                                    l--, f += o[i++] << h, h += 8
                                                }
                                                f >>>= ge, h -= ge, xe = 0, g = 11 + (127 & f), f >>>= 7, h -= 7
                                            }
                                ...
                                case ne:
                                    if (l >= 6 && d >= 258) {
                                        e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, r.hold = f, r.bits = h, k(e, m), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = r.hold, h = r.bits, r.mode === Y && (r.back = -1);
                                        break
                                    }
                                ...
                                case se:
                                    ...
                                    if (g = m - d, r.offset > g) {
                                        ...
                                        g > r.wnext ? (g -= r.wnext, p = r.wsize - g) : p = r.wnext - g, g > r.length && (g = r.length), me = r.window
                        ...
                        var g, p, w = e("../utils/common"),
                            ...
                            we = pe,
                            ve = !0;
                        r.inflateReset = i, r.inflateReset2 = s, r.inflateResetKeep = a, r.inflateInit = d, r.inflateInit2 = l, r.inflate = f, r.inflateEnd = h, r.inflateGetHeader = b, r.inflateSetDictionary = m, r.inflateInfo = "pako inflate (from Nodeca project)"
                    },
                    ...
                    "zlib/inffast.js": function (e, t, r) {
                        ...
                        t.exports = function (e, t) {
                            ...
                            r = e.state, a = e.next_in, B = e.input, i = a + (e.avail_in - 5), s = e.next_out, U = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = r.dmax, c = r.wsize, f = r.whave, h = r.wnext, b = r.window, m = r.hold, g = r.bits, p = r.lencode, w = r.distcode, v = (1 << r.lenbits) - 1, y = (1 << r.distbits) - 1;
                            e: do {
                                g < 15 && (m += B[a++] << g, g += 8, m += B[a++] << g, g += 8), k = p[m & v];
                                t: for (;;) {
                                    if (x = k >>> 24, m >>>= x, g -= x, x = k >>> 16 & 255, 0 === x) U[s++] = 65535 & k;
                                    else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                                                k = p[(65535 & k) + (m & (1 << x) - 1)];
                                        ...
                                        _ = 65535 & k, x &= 15, x && (g < x && (m += B[a++] << g, g += 8), _ += m & (1 << x) - 1, m >>>= x, g -= x), g < 15 && (m += B[a++] << g, g += 8, m += B[a++] << g, g += 8), k = w[m & y];
                                        r: for (;;) {
                                            ...
                                            if (m >>>= x, g -= x, x = s - l, S > x) {
                                                ...
                                                for (; _ > 2;) U[s++] = C[E++], U[s++] = C[E++], U[s++] = C[E++], _ -= 3;
                                                _ && (U[s++] = C[E++], _ > 1 && (U[s++] = C[E++]))
                                            } else {
                                                E = s - S;
                                                do U[s++] = U[E++], U[s++] = U[E++], U[s++] = U[E++], _ -= 3; while (_ > 2);
                            ...
                            _ = g >> 3, a -= _, g -= _ << 3, m &= (1 << g) - 1, e.next_in = a, e.next_out = s, e.avail_in = a < i ? 5 + (i - a) : 5 - (a - i), e.avail_out = s < d ? 257 + (d - s) : 257 - (s - d), r.hold = m, r.bits = g
                        }
                    },
                    "zlib/inftrees.js": function (e, t, r) {
                        ...
                        t.exports = function (e, t, r, b, m, g, p, w) {
                            ...
                            if (I > O && (I = O), 0 === O) return m[g++] = 20971520, m[g++] = 20971520, w.bits = 1, 0;
                            for (L = 1; L < O && 0 === j[L]; L++);
                            ...
                            if (e === s ? (F = M = p, S = 19) : e === l ? (F = u, Z -= 257, M = c, W -= 257, S = 256) : (F = f, M = h, S = -1), N = 0, R = 0, T = L, _ = g, A = I, P = 0, k = -1, z = 1 << I, x = z - 1, e === l && z > a || e === d && z > i) return 1;
                            for (;;) {
                                E = T - P, p[R] < S ? (C = 0, B = p[R]) : p[R] > S ? (C = M[W + p[R]], B = F[Z + p[R]]) : (C = 96, B = 0), v = 1 << T - P, y = 1 << A, L = y;
                                do y -= v, m[_ + (N >> P) + y] = E << 24 | C << 16 | B | 0; while (0 !== y);
                                for (v = 1 << T - 1; N & v;) v >>= 1;
                                if (0 !== v ? (N &= v - 1, N += v) : N = 0, R++, 0 === --j[T]) {
                                    if (T === O) break;
                                    T = t[r + p[R]]
                                }
                                if (T > I && (N & x) !== k) {
                                    for (0 === P && (P = I), _ += L, A = T - P, D = 1 << A; A + P < O && (D -= j[A + P], !(D <= 0));) A++, D <<= 1;
                                    if (z += 1 << A, e === l && z > a || e === d && z > i) return 1;
                                    k = N & x, m[k] = I << 24 | A << 16 | _ - g | 0
                                }
                            }
                            return 0 !== N && (m[_ + N] = T - P << 24 | 64 << 16 | 0), w.bits = I, 0
                        }
                    }
                };
    ...
    return new Promise(function (e, t) {
        f.SystemInfo.hasWebGL ? 1 == f.SystemInfo.hasWebGL ? t('Your browser does not support graphics API "WebGL 2" which is required for this content.') : f.SystemInfo.hasWasm ? (1 == f.SystemInfo.hasWebGL && f.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), f.startupErrorHandler = t, r(0), f.postRun.push(function () {
            r(1), delete f.startupErrorHandler, e(p)
